...
SYSTEM_PROMPT = {
    ...
    "content": (
        ...
        "paragraph.\n"
        "- SAY EACH THING ONCE. No 'Quick version', recap or summary "
        "block restating content already delivered; a closing list "
        "may only ADD information, never re-announce the verdict.\n"
        ...
        "you answer from memory — in WORLD-FACING words attached to "
        "the figure ('~$20 — check current'), NEVER the meta phrasing "
        "'as of my last data' / 'my training', which names the "
        "machinery. Never name "
                ...
                if placey:
                    ...
                    if _osm:
                        ...
                        snippets = (
                            ...
                            "cafe in Virginia answered a Brooklyn "
                            "question — seen live); snippets give "
